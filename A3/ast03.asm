...
;	dAns11 = wNum1 * wNum4
	...
	mov dword [dAns11+2], edx
;	dAns12  = wNum4 * wNum4
	mov ax, word [wNum4]
	mul word [wNum4]
	mov dword [dAns12], eax
	mov dword [dAns12+2], edx
;	dAns13  = wNum2 * wNum3
	mov ax, word [wNum2]
	mul word [wNum3]
	mov dword [dAns13], eax
	mov dword [dAns13+2], edx
...
;	dAns14  = wNum5 * wNum7
	...
	mov dword [dAns14+2], edx
;	dAns15  = wNum6 * wNum8
	mov ax, word [wNum6]
	imul word [wNum8]
	mov dword [dAns15], eax
	mov dword [dAns15+2], edx
